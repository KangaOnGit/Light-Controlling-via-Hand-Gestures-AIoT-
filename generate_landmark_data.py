...
if __name__ == "__main__":
    LABEL_TAG = label_dict_from_config_file("C:\AIoT (Rudimentary)\Dataset\hand_gesture.yaml")
    data_path = 'C:\AIoT (Rudimentary)\Dataset (Backup)'
    sign_img_path = 'C:\AIoT (Rudimentary)\sign_img'
